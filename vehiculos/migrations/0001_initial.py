# Generated by Django 4.1.4 on 2023-05-23 16:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Vehiculo',
            fields=[
                ('patente', models.CharField(max_length=8, primary_key=True, serialize=False, verbose_name='Patente')),
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vehiculos.categoria', verbose_name='Categoria')),
            ],
        ),
    ]
